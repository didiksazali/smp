...
(function(){
	...
	Chart.Animation = Chart.Element.extend({
		...
		onAnimationProgress: null, // admin specified callback to fire on each step of the animation
		onAnimationComplete: null, // admin specified callback to fire when the animation finishes
	});
